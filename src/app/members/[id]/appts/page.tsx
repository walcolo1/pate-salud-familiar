    ...
    <div className="flex flex-col gap-6 select-none pb-12">
      ...
      <section className="flex flex-col gap-3.5">
        {filteredAppts.length === 0 ? (
          <EstadoVacio
            icono={Calendar}
            titulo="No hay citas médicas"
            descripcion="No se encontraron citas correspondientes al filtro seleccionado."
            accion={{ tipo: 'boton', etiqueta: 'Programar cita', onClick: () => setShowAddForm(true) }}
          />
        ) : (
