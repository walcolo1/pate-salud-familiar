    ...
    <div className="flex flex-col gap-6 select-none pb-12">
      ...
      <section className="flex flex-col gap-3.5">
        {filteredOrders.length === 0 ? (
          <EstadoVacio
            icono={ClipboardList}
            titulo="No hay órdenes registradas"
            descripcion="Registra tus órdenes de citas con especialistas, laboratorios o terapias y lleva control del estado de tu trámite."
            accion={{ tipo: 'boton', etiqueta: 'Nueva orden', onClick: () => setShowAddForm(true) }}
          />
        ) : (
      ...
      <Dialog
        abierto={showAddForm}
        titulo="Registrar Nueva Orden Médica"
