 ...
 */
export const COLUMNAS_SINCRONIZACION = [
  'creado_en',
  'actualizado_en',
  'borrado_en',
] as const;
...
export interface DefinicionPestana {
  /** Nombre exacto de la pestaña. En mayúsculas, sin espacios ni tildes. */
  nombre: string;
  /** Qué guarda, en una línea. Va al `.gs` generado como comentario. */
  descripcion: string;
  /** Encabezados de la fila 1, en orden. */
  encabezados: readonly string[];
}

/** Añade las columnas de cierre a una lista de campos propios. */
const conSincronizacion = (...campos: string[]): readonly string[] => [
  ...campos,
